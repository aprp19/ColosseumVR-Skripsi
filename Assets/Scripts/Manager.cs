...
public class Manager : MonoBehaviour
{
    ...
    {
        if (Input.GetKeyUp(KeyCode.F) || Input.GetButtonDown("RB") && shootButton.IsActive() && shootButton.IsInteractable())
            shootButton.onClick.Invoke();

        if (Input.GetKeyUp(KeyCode.LeftArrow) || Input.GetButtonDown("X"))
        {
        ...
        if (Input.GetKeyUp(KeyCode.RightArrow) || Input.GetButtonDown("B") && attackButton.IsActive() && attackButton.IsInteractable())
            attackButton.onClick.Invoke();

        if (Input.GetKeyUp(KeyCode.UpArrow) || Input.GetButtonDown("Y"))
        {
        ...
        if ((Input.GetKeyUp(KeyCode.DownArrow) || Input.GetKeyUp(KeyCode.Space)) || Input.GetButtonDown("A") && jumpButton.IsActive() && jumpButton.IsInteractable())
